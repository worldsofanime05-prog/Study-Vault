/* ============================================================
   ...
   STEP 5b — Enable Firebase Storage & set Storage Rules
   ──────────────────────────────────────────────────────
   • Left sidebar → Build → Storage → Get started
   • Choose "Production mode" → Next → Enable
   • Inside Storage → Rules tab → Replace with:
   ...
   STEP 5c — Add your GitHub Pages domain to Authorized Domains
   ────────────────────────────────────────────────────────────
